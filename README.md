# Intro
This is a computational neuroscience project implementing and exploring the **Leaky Integrate-and-Fire (LIF)** neuron model, guided by the _Neuromatch Academy_ curriculum. While _Neuromatch Academy_ provides step-by-step guidance, I consolidated those steps into a object-oriented Python simulation (`LIFNeurons` class).
